...
ANALYZER_SYSTEM_PROMPT = """You are an AI agent that analyzes the Excel provided by the user.
...
GENERATOR_SYSTEM_PROMPT = """You are an AI agent that generates new Excel rows based on analysis results and sample data.
...
1. Describe the formatting of the dataset, including the structure of the Excel.
...
GENERATOR_USER_PROMPT = """Generate {num_rows} new Excel rows based on the analysis and sample data:
